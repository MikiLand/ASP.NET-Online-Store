            ...
            <div class="row">
                <div class="col-md-4">
                    <center>
                        ...
                        <h4>Candles</h4>
                        <p class="text-justify">We have a wide selection of unique candles to suit every need. Candles are not only a fragrance but also a spiritual journey that you may never experience</p>
                    </center>
                </div>
                ...
                <div class="col-md-4">
                    <center>
                        ...
                        <h4>Scents</h4>
                        <p class="text-justify">Our fragrances will create a unique atmosphere and transport your mind to a completely different place, better place</p>
                    </center>
                </div>
                ...
                <div class="col-md-4">
                    <center>
                        ...
                        <h4>Other</h4>
                        <p class="text-justify">However, do not worry if candles and fragrances are not what you are looking for in the adventure called life. In our store we have much more to offer</p>
                    </center>
                </div>
            </div>
        </div>
